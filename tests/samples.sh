...
'http://192.168.11.60:1079/query/predict?data={"prefix":"heji","num":5,"filters":{"we_account_id":100100209}}'
'http://192.168.11.60:1079/query/predict?data={"prefix":"hejia","num":5,"filters":{"we_account_id":100100209}}'
'http://192.168.11.60:1079/query/predict?data={"prefix":"hjy","num":5,"filters":{"we_account_id":100100209}}'
